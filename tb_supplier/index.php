                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="edit-supplier.php?id=<?php echo $row['id_supplier'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                                            <a href="hapus-supplier.php?id=<?php echo $row['id_supplier'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                                        </td>
                                    </tr>
