                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="edit.php?id=<?php echo $row['id_member'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                                            <a href="hapus.php?id=<?php echo $row['id_member'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                                        </td>
                                    </tr>
